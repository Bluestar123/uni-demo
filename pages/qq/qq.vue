<template>
	<view>
		dsds
		<canvas @touchend="touchend" @longtap="touchmove" canvas-id="myCanvas" @touchmove="touchmove"/>
	</view>
</template>
	...
	export default {
		...
		methods:{
			...
			touchmove: function(e){
				...
				this.x = e.mp.changedTouches[0].x;
				this.y = e.mp.changedTouches[0].y;
				this.anchorX =  (e.mp.changedTouches[0].x + this.startX)/2;
				this.anchorY =  (e.mp.changedTouches[0].y + this.startY)/2;
				this.onDrow();
